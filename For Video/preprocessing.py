...
# All_pics_directory = current_directory + "\\..\\"+"Photos"
...
#                     for list in my_list:
#                         if face_recognition.compare_faces([np.array(list['encoding'])], encoding,tolerance=0.57)[0]:
...
current_directory = os.getcwd()
All_pics_directory = current_directory + "\\..\\"+"Photos2"
result_json_dir = current_directory + "\\..\\result.json"
dataset_dir = current_directory + "\\..\\"+"Dataset"
class_cnt = 0
